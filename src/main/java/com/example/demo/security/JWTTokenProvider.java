...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(CustomerPrincipal customerPrincipal) {
        ...
        return JWT.create().withIssuer(GET_ARRAYS_LLC).withAudience(GET_ARRAYS_ADMINISTRATION)
                .withIssuedAt(new Date()).withSubject(customerPrincipal.getUsername())
    ...
    private String[] getClaimsFromCustomer(CustomerPrincipal customer) {
        List<String> authorities = new ArrayList<>();
        for (GrantedAuthority grantedAuthority : customer.getAuthorities()) {
